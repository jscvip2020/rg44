 ...
 * Time: 13:19
 */ ?>
@section('titulo', ' - Editando Galeria')
<x-app-layout>
    <x-slot name="header">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card m-auto" style="max-width: 600px;">
                        <div class="card-body">
                            <form class="form-horizontal" method="post" action="{{ route('galerias.update', $gallery->id) }}">
                                @method('put')
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="text" class="form-control {{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               ...
                                               value="{{ isset($row) ? $row->$input : $gallery->titulo }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="text" class="form-control{{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               value="{{ isset($row) ? $row->$input : $gallery->apikey }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="text" class="form-control{{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               ...
                                               value="{{ isset($row) ? $row->$input : $gallery->userid }}">
                                        <small id="apikeyHelper" class="form-text text-muted">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="number" class="form-control{{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               value="{{ isset($row) ? $row->$input : $gallery->perpagealbum }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="number" class="form-control{{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               value="{{ isset($row) ? $row->$input : $gallery->perpagephoto }}">
                                        @if ($errors->has($input))
                                            <span class="help-block invalid-feedback"><strong>{{ $errors->first($input) }}</strong></span>
                                        @endif
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="number" class="form-control{{ $errors->has($input) ? ' is-invalid' : '' }}" name="{{$input}}"
                                               value="{{ isset($row) ? $row->$input : $gallery->perpagelist }}">
                                        @if ($errors->has($input))
                                            <span class="help-block invalid-feedback"><strong>{{ $errors->first($input) }}</strong></span>
                                        @endif
                                    </div>
