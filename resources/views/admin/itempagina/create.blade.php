                    ...
                    <div class="card m-auto" style="max-width: 600px;">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('itempaginas.store') }}"
                                ...
                                <div class="form-group">
                                    <label for="{{$input}}" class="col-md-12 control-label">Titulo do Item da
                                        Pagina</label>
                                    ...
                                    <div class="col-md-12">
                                        <input id="{{$input}}" type="text"
                                               ...
                                               name="{{$input}}"
                                               placeholder="Titulo do Item da Página"
                                ...
                                <div class="form-group">
                                    <label for="{{$input}}" class="col-md-12 control-label">Texto do Item da
                                        Pagina</label>
    ...
    @section('script')
        <script type="text/javascript">
            ...
            CKEDITOR.replace('texto', {
                filebrowserUploadUrl: "{{route('ckeditor.itemupload', ['_token' => csrf_token()])}}",
