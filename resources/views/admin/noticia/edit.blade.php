            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card m-auto" style="max-width: 600px;">
                        <div class="card-body">
                            <form class="form-horizontal" method="POST" action="{{ route('noticias.update',[$row->id]) }}" enctype="multipart/form-data">
                                @method('put')
                                {{ csrf_field() }}
    ...
    @section('script')
        <script type="text/javascript">
            ...
            CKEDITOR.replace('textoEdit', {
                filebrowserUploadUrl: "{{route('ckeditor.uploadEdit', ['id'=>$row->id,'_token' => csrf_token()])}}",
