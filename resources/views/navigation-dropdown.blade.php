                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <x-jet-dropdown align="right" width="48" >
                            ...
                            <x-slot name="content">
                                <x-jet-dropdown-link href="{{ route('paginas.index') }}">
                                {{ __('Menus') }}
                                </x-jet-dropdown-link>
                                <x-jet-dropdown-link href="{{ route('itempaginas.index') }}">
                                {{ __('Paginas') }}
                                </x-jet-dropdown-link>
                            </x-slot>
                        </x-jet-dropdown>
                    ...
                    <x-jet-nav-link href="{{ route('ensaios.index') }}" :active="request()->routeIs(['ensaios.index','ensaios.create','ensaios.edit'])">
                        {{ __('Ensaios') }}
                    </x-jet-nav-link>
